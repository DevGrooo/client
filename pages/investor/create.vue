<template>
  <b-form ref="form" name="formCreateInvestor" :validates="validates" css="form-horizontal" @onSubmit="onSubmit">
    <div class="card ">
      <div class="card-header ">
        <h4 class="card-title">{{ $t('investor.Create Investor') }}</h4>
      </div>
      <div class="card-body ">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <b-select name="fund_distributor_code" :options="fund_distributors">
              <option value="">{{ $t('investor.Select Fund Distributor') }}</option>
            </b-select>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-4">
            <b-select name="zone_type" :options="zone_types" @input="onChange">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <b-select name="scale_type" :options="scale_types" @input="onChange">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <b-input name="name" type="text" class-css="form-control text-uppercase" @input="onChange" />
          </div>
          <template v-if="scale_type === '1'">
          ...
          <template v-else>
            <b-input-hidden name="gender" value="O" />
          </template>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <b-select name="id_type_id" :options="id_types">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <b-input name="account_holder" :value="account_holder" :disabled="true" type="text" class-css="form-control text-uppercase" />
          </div>
        </div>
      ...
      <div class="card-footer ">
        <div class="row">
          <div class="col-md-2"></div>
          <div class="col-md-10">
            <button type="submit" class="btn btn-primary">{{ $t('investor.Create Investor') }}</button>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  import { vietnameseWithoutAccent } from '@/untils/functions'
  import { accountHolder, accountNumber, date, idNumber, isTradingAccountNumber, isGender, isExternalRequired } from '@/components/UI/form/BValidate'
  import {
    ...
    callApiInvestorCreate
  } from '@/apis/investor'
  import { callApiFundDistributorGetListCode } from '@/apis/fund_distributor'
  ...
  export default {
    ...
    data () {
      return {
        ...
        validates: {
          ...
          fatca1: {
            rules: { isExternalRequired, integer },
            messages: {
              isExternalRequired: this.$t('investor.Fatca1 is required'),
          ...
          fatca2: {
            rules: { isExternalRequired, integer },
            messages: {
              isExternalRequired: this.$t('investor.Fatca2 is required'),
          ...
          fatca3: {
            rules: { isExternalRequired, integer },
            messages: {
              isExternalRequired: this.$t('investor.Fatca3 is required'),
          ...
          fatca4: {
            rules: { isExternalRequired, integer },
            messages: {
              isExternalRequired: this.$t('investor.Fatca4 is required'),
          ...
          fatca5: {
            rules: { isExternalRequired, integer },
            messages: {
              isExternalRequired: this.$t('investor.Fatca5 is required'),
          ...
          fatca6: {
            rules: { isExternalRequired, integer },
            messages: {
              isExternalRequired: this.$t('investor.Fatca6 is required'),
          ...
          fatca7: {
            rules: { isExternalRequired, integer },
            messages: {
              isExternalRequired: this.$t('investor.Fatca7 is required'),
              integer: this.$t('investor.Fatca7 country invalid')
            }
          },
          fatca_funds: {
            rules: { isExternalRequired, maxLength: maxLength(255) },
            messages: {
              isExternalRequired: this.$t('investor.Fatca Funds is required'),
          ...
          fund_distributor_code: {
            rules: { required },
            messages: {
              required: this.$t('investor.Fund Distributor is required')
            }
          },
    ...
    async created () {
      ...
      this.fund_distributors = await callApiFundDistributorGetListCode(this)
    ...
    methods: {
      onChange (name, value) {
        ...
        if (name === 'name') {
          this.account_holder = vietnameseWithoutAccent(value)
        }
      },
      async onSubmit (params) {
        const result = await callApiInvestorCreate(this, params)
        if (result.status === true) {
          this.flashMessage.success({
            title: this.$t('investor.Create Success'),
            message: this.$t('investor.Create Success')
          })
          this.$router.push(this.localePath('/investor'))
        } else {
          this.flashMessage.error({
            title: this.$t('investor.Create Error'),
